...
def get_activation(name: str) -> "nn.Module":
    ...
    if not TORCH_AVAILABLE:
        raise RuntimeError("PyTorch is required for VAE")
...
class TabularVAE(nn.Module):
    ...
    def __init__(
        ...
        """
        if not TORCH_AVAILABLE:
            raise RuntimeError("PyTorch is required for TabularVAE")
...
class VAETrainer:
    ...
    def __init__(
        ...
        """
        if not TORCH_AVAILABLE:
            raise RuntimeError("PyTorch is required for VAETrainer")
...
def load_vae_from_checkpoint(
    ...
    """
    if not TORCH_AVAILABLE:
        raise RuntimeError("PyTorch is required to load VAE checkpoint")
