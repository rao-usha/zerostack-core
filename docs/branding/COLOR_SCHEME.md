# zerostack Dark Mode Color Scheme

## Overview
zerostack features a modern, sophisticated dark mode design with vibrant accent colors that convey innovation and cutting-edge technology.
...
#### Primary Gradient (zerostack Brand)
```css
...
## Logo Colors
The zerostack logo uses a three-color gradient:
- Start: `#3b82f6` (Blue)
